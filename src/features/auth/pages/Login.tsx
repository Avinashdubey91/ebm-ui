...
const Login: React.FC = () => {
  ...
  return (
    <div className="container-fluid d-flex align-items-stretch gap-4 py-3 self-solutions-login-body" style={{ height: '100vh', boxSizing: 'border-box' }}>
      {/* Left Side */}
      ...
      <div className="self-solutions-login-right-side">
        <div className="self-solutions-login-login-box">
          ...
          <h4 className="self-solutions-login-login-title">Login to Self Solutions</h4>
          ...
          <div className="row self-solutions-login-row mb-3">
            <div className="col-6 d-grid">
              <button type="button" className="btn btn-outline-danger" onClick={() => { setUsername(''); setPassword(''); }}>
